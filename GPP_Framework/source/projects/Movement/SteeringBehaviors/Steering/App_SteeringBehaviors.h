...
private:
	...
	ImGui_Agent App_SteeringBehaviors::AddAgent(BehaviorTypes behaviorType = BehaviorTypes::Seek, int targetId = -1, bool autoOrient = true, float mass = 1.f, float maxSpd = 7.f);
	...
	ContextSteering* m_pContextSteering = nullptr;
};
#endif